...
export const TASK_SET_EDIT_ID = '[task] set edit id';

export const TASK_EDIT = '[task] edit';
export const TASK_EDIT_START = '[task] edit start';
export const TASK_EDIT_SUCCESS = '[task] edit success';
export const TASK_EDIT_ERROR = '[task] edit error';

export const TASK_DELETE = '[task] delete';
export const TASK_DELETE_START = '[task] delete start';
export const TASK_DELETE_SUCCESS = '[task] delete success';
export const TASK_DELETE_ERROR = '[task] delete error';
